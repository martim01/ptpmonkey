...
namespace pml::ptpmonkey
{
    ...
    namespace mngmnt
    {
        ...
        enum class enumId : std::uint16_t {ERROR                                =0,
                                           ...
                                           GRANDMASTER_CLUSTER_TABLE            = 0x2017,
                                           ...
                                           ACCEPTABLE_MASTER_MAX_TABLE_SIZE     = 0x201C,
                                           ...
                                           EXTERNAL_PORT_CONFIGURATION_ENABLED  = 0x3000,
                                           MASTER_ONLY                          = 0x3001,
                                           HOLDOVER_UPGRADE_ENABLE              = 0x3002,
                                           EXT_PORT_CONFIG_PORT_DATA_SET        = 0x3003,
                                           ...
                                           PORT_HWCLOCK_NP                      = 0xC009,
                                           POWER_PROFILE_SETTINGS_NP            = 0xC00A,
                                           CMLDS_INFO_NP                        = 0xC00B 
                                        };
