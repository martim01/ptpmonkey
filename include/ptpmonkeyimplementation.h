#ifndef PML_PTPMONKEY_PTPMONKEYIMPLEMENTATION_H
#define PML_PTPMONKEY_PTPMONKEYIMPLEMENTATION_H
...
class PtpMonkeyImplementation
{
    public:
        ...
        **/
        ...
        bool SendDelayRequests() const { return (m_delayRequest != Rate::kNever); }
    ...
    protected:
        ...
        static const std::string kMulticast;
    };  
}
#endif